...
public class VirtualKeyforYourRepositories {
		...
		public static void welcomeMsg() {     // Print the welcome massage  
			System.out.println("________________________________________\n\n"
					...
					+ "The name of the devaloped is Abdulrahman alhamood\n"
		...
		public static void MOSelector() {             // Main options list
			...
			switch(x) {
				...
				case 3:                                         // Exit the program 
					System.out.println("Thank you for useing my Program and good bay");
					System.exit(0);
					break;
		...
		public static void addFile() {                                    // Create new file of folder
			...
			switch(x) {
				case 1:                                               // To create a file
					...
					try {
						FileWriter f = new FileWriter("Abdulrahman\\"+userInput);   // Create a file
						f.close();
						System.out.println(" File created seccessfully");
					} catch (Exception e) {
				...
				case 2:         									// to create a folder 
					...
					File dir = new File("Abdulrahman\\"+userInput2);
					dir.mkdir();                                                      // Create a folder
					System.out.println(" Folder created seccessfully");
					break;
		...
		public static void deleteFile() {  // To delete a file
			...
			File dir = new File("Abdulrahman");   // The directory path
	    	...
	    	for(int i=0 ; i < dirList.length ; i++) {
		    	...
		    	if( dirList[i].getName().equals(userInput)) {
		    		File myObj = new File("Abdulrahman\\"+userInput); 
		    		if (myObj.delete()) { 
		...
		public static void main(String[] args) {
	    	...
	    	new VirtualKeyforYourRepositories();
